...
/** @constructor */
var $c_LScalaJSExample$ = (function() {
  $c_O.call(this)
});
$c_LScalaJSExample$.prototype = new $h_O();
$c_LScalaJSExample$.prototype.constructor = $c_LScalaJSExample$;
/** @constructor */
var $h_LScalaJSExample$ = (function() {
  /*<skip>*/
});
$h_LScalaJSExample$.prototype = $c_LScalaJSExample$.prototype;
$c_LScalaJSExample$.prototype.init___ = (function() {
  $n_LScalaJSExample$ = this;
  return this
});
$c_LScalaJSExample$.prototype.main__V = (function() {
  ...
  var parNode = $g["document"]["getElementById"]("tickets");
  var textNode = $g["document"]["createTextNode"]("School MyEdu");
  parNode["appendChild"](textNode);
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V(parNode, "Hello World")
});
$c_LScalaJSExample$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_LScalaJSExample$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var parNode = $g["document"]["createElement"]("p");
  var textNode = $g["document"]["createTextNode"](text);
  parNode["appendChild"](textNode);
  targetNode["appendChild"](parNode)
});
$c_LScalaJSExample$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_LScalaJSExample$ = new $ClassTypeData({
  LScalaJSExample$: 0
}, false, "ScalaJSExample$", {
  LScalaJSExample$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_LScalaJSExample$.prototype.$classData = $d_LScalaJSExample$;
var $n_LScalaJSExample$ = (void 0);
var $m_LScalaJSExample$ = (function() {
  if ((!$n_LScalaJSExample$)) {
    $n_LScalaJSExample$ = new $c_LScalaJSExample$().init___()
  };
  return $n_LScalaJSExample$
});
$e["ScalaJSExample"] = $m_LScalaJSExample$;
